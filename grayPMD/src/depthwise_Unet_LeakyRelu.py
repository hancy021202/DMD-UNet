...
class Depthwiseconv(nn.Module):#深度可分离卷积
    ...
    def forward(self,input):
        ...
        return out
class normal_conv_layer_BN_LRelu(nn.Module):#conv+bn
    def __init__(self,in_channels,out_channels,kernel_size=3,strides=1,padding=1):
        super(normal_conv_layer_BN_LRelu, self).__init__()
    ...
    def forward(self,x):
        ...
        out=F.leaky_relu(x2)
        return  out
class depthwise_separable_residual_conv(nn.Module):#残差
    def __init__(self,in_channels,out_channels):
        ...
        self.depth_conv=Depthwiseconv(2*in_channels,2*in_channels)    #2*？
    ...
    def forward(self,x):
        ...
        out=x7+x
        return  out
class transposed_conv(nn.Module):#转置卷积
...
class encoder_block(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.conv1=normal_conv_layer_BN_LRelu(in_channels, out_channels)
